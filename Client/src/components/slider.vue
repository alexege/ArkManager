...
<template>
    <div class="point-size-selector">
        ...
        <div class="point-container">
            ...
            <input type="range" min="5" max="25" step="5" v-model="pointSize" @input="updatePreview" />
            <p>{{ pointSize }} px</p>
        </div>

        <div class="point-preview">
            <div class="preview-point"
                :style="[{ width: pointSize + 'px', height: pointSize + 'px' }, { background: props.point.color }]"></div>
        </div>
