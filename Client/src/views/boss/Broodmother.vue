...
const requirements = ref([
    ...
    },
    {
        ...
        img: '/assets/trophies/Titanoboa_Venom.png',
        gamma: 0,
        beta: 5,
        alpha: 10,
        amount: 0
...
const unlocks = ref([
    ...
    {
        name: 'Tek Foundation',
        img: '/assets/engrams/Tek_Foundation.png',
        gamma: true,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Triangle_Foundation.png',
        gamma: true,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Triangle_Roof.png',
        gamma: true,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Quarter_Wall.png',
        gamma: true,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Pillar',
        img: '/assets/engrams/Tek_Pillar.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Wall.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Ceiling.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    ...
    },
    {
        ...
        img: '/assets/engrams/Tek_Sloped_Wall_Right.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Ladder',
        img: '/assets/engrams/Tek_Ladder.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Boots',
        img: '/assets/engrams/Tek_Boots.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Turret',
        img: '/assets/engrams/Tek_Turret.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Helmet',
        img: '/assets/engrams/Tek_Helmet.png',
        gamma: false,
        beta: false,
        alpha: true
    }
...
<template>
    <div>
        <div class="header">
            <h2>Broodmother Lysrix</h2>
            <img src="https://www.dododex.com/media/creature/broodmotherlysrix.png" class="item-img" width="200px"
                style="margin: 0 auto;" />
            ...
            <div class="column-one">
                <div class="tributes">
                    ...
                    <div class="tributes-grid">
                        ...
                        <div class="grid-title" :class="isActiveTier('gamma')">30</div>
                        <div class="grid-title" :class="isActiveTier('beta')">30</div>
                        <div class="grid-title" :class="isActiveTier('alpha')">70</div>
