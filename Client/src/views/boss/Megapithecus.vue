...
const requirements = ref([
    ...
    },
    {
        ...
        img: '/assets/trophies/Megalania_Toxin.png',
        gamma: 0,
        beta: 5,
        alpha: 10,
        amount: 0
    },
    {
        ...
        img: '/assets/trophies/Megalodon_Tooth.png',
        gamma: 0,
        beta: 5,
        alpha: 10,
        amount: 0
    ...
    },
    {
        ...
        img: '/assets/trophies/Therizino_Claws.png',
        gamma: 0,
        beta: 5,
        alpha: 10,
        amount: 0
...
const unlocks = ref([
    ...
    {
        name: 'Tek Gauntlets',
        img: '/assets/engrams/Tek_Gauntlets.png',
        gamma: true,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Generator',
        img: '/assets/engrams/Tek_Generator.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Dinosaur_Gateway.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        ...
        img: '/assets/engrams/Tek_Dinosaur_Gate.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Large Cellar Door',
        img: '/assets/engrams/Tek_Large_Cellar_Door.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Trough',
        img: '/assets/engrams/Tek_Trough.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Rifle',
        img: '/assets/engrams/Tek_Rifle.png',
        gamma: false,
        beta: true,
        alpha: true
    },
    {
        name: 'Tek Large Wall',
        img: '/assets/engrams/Tek_Large_Wall.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Grenade',
        img: '/assets/engrams/Tek_Grenade.png',
        gamma: false,
        beta: false,
        alpha: true
    },
    {
        name: 'Tek Rex Saddle',
        img: '/assets/engrams/Tek_Rex_Saddle.png',
        gamma: false,
        beta: false,
        alpha: true
    }
            ...
            <div class="column-one">
                <div class="tributes">
                    ...
                    <div class="tributes-grid">
                        ...
                        <div class="grid-title" :class="isActiveTier('gamma')">45</div>
                        <div class="grid-title" :class="isActiveTier('beta')">65</div>
                        <div class="grid-title" :class="isActiveTier('alpha')">85</div>
